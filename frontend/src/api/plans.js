...
export const reactivatePlan = (id) =>
  client.post(`/plans/${id}/reactivate`).then((r) => r.data);

export const permanentlyDeletePlan = (id) =>
  client.delete(`/plans/${id}/permanent`).then((r) => r.data);
